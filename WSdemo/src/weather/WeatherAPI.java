...
public class WeatherAPI {
	...
	public String sayHelloXML() {
		...
		//sb.append("http://api.openweathermap.org/data/2.5/weather?id=707860&appid=55bc8d25d41265c6f6f301f5038b0ad0");
		 ...
		 * "jdbc:mysql://localhost:3306/sys","root","root"); //here sonoo is database
		 * name, root is username and password Statement stmt=con.createStatement();
		 * ResultSet rs=stmt.
		 * executeQuery("INSERT INTO sehir,temperature,humidity,pressure,location VALUES temp1[0],humidity1[0],pressure1[0],location1[0]"
		 * ); //while(rs.next())
		 * //System.out.println(rs.getInt(1)+"  "+rs.getString(2)+"  "+rs.getString(3));
		 * con.close(); }catch(Exception e){ System.out.println(e);}
		 */

		String response = "<?xml version='1.0'?>" + "<hello>" + "Temperature: " + temp1[0] + "\n\nHumidity: "
				+ humidity1[0] + "\n\nPressure: " + pressure1[0] + "Location: " + location1[0] + "</hello>";
		return response;
